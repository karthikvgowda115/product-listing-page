            ...
            {cartItems.map((item) => (
              <div key={`${item.id}-${item.selectedSize}-${item.selectedColor}`} className="cart-item">
                <div className="item-image">
                  <img src={item.image_url || 'https://images.unsplash.com/photo-1580910051074-3eb694886505'} alt={item.name} />
                </div>
                ...
                <div className="item-details">
                  ...
                  <div className="item-attributes">
                    ...
                    <span className="attribute">Material: {item.material || 'Cotton'}</span>
                  </div>
                </div>
